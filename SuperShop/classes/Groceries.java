        ...
        public int displayGrocerieBill() {
            ...
            while(true) {
                ...
                if(i == '*') {
                    ...
                    totalBill += 35;
                    System.out.println("Bill from this section 35/-");
                    System.out.println("Amount = "+totalBill+" Tk");
                    ...
                    totalBill += 60;
                    System.out.println("Bill from this section 60/-");
                    System.out.println("Amount = "+totalBill+" Tk");
                    ...
                    totalBill += 120;
                    System.out.println("Bill from this section 120/-");
                    System.out.println("Amount = "+totalBill+" Tk");
