...
public class Employees {
   ...
   private String Maritial_Status;
    ...
    public Employees(String name, String id, int salary, String emp_Father_name, String emp_mother_name, String dob, String joindate, String per_address, String pre_Address, String email, String phone,String Marital_Status) {
              this.name = name;
              this.id = id;
              this.Salary = salary;
    ...
    public void Employeeinfo(){
         ...
         System.out.println("Employee's Permanent Address      : "+Per_address);
